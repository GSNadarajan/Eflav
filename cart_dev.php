...
<body style="background-color:#1a1a1a;font-family: cursive;">
    <div class="mob-nav">
        <nav class="navbar navbar-expand-lg text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <div>
                    <a href="item_dev.php" style="text-decoration:none;color:white;font-size:25px;"><i class="bi bi-arrow-left-circle-fill"></i></a>
                    <a href="item_dev.php " style="color:white !important" class="navbar-brand">Eflav</a>
                </div>
        ...
        ?>
            <div class="container mt-5">
                        ...
                        <tbody>
                            ...
                            foreach ($data as $key => $value) {
                                if ($key != "number" && $key != "name") {
                                    if ($key != "total_amount" && $key != "add" && $key != "count" && !stristr($key, "item_count_")) {
                                        $split = explode("_", $key);
                                        $item_id = $split[1];
                ...
                ?>
                    ...
                    <a href="cart_dev.php?order_success">
