                ...
                <div class="">
                    ...
                    <form action="movie.php" method="post" style="margin: 0px;">
                        <div class="mb-1">
                            ...
                            <input type="phone" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp">
                            <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
                        </div>

                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label text-white mt-3">Enter mobile number</label>
                            <input type="phone" class="form-control" name="number" id="exampleInputEmail1" aria-describedby="emailHelp">
