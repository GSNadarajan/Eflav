                ...
                <div class="card shadow-sm zoom car1" >
                    ...
                    <img src="<?= $value['image_url'] ?>" class="img-fluid ml-5 card_img">
                        ...
                        <div class="counter">
                            ...
                            <button onclick="totalclick(-1,4,<?=$value['id']?>)" class="minus">-</button>
                            <span id="totalclicks_4_<?=$value['id']?>" class="result"><?php
                            if($destroyed != 1){
                                $item_id = $value['id'];
                                $session_key = "4_$item_id";
                            ...
                            ?></span>
                            <button onclick="totalclick(1,4,<?=$value['id']?>)" class="plus">+</button>
